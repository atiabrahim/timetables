        ...
        <Table className="border-4 border-slate-950 w-full">
          <TableHeader>
            <TableRow className="bg-slate-100 border-b-4 border-slate-950">
              <TableHead className={cn("font-black text-slate-950 border-e-4 border-slate-950 p-2 text-xs w-[200px] whitespace-nowrap", isRTL ? "text-right" : "text-left")}>{t.employeeName}</TableHead>
