          ...
          <table className={cn("w-full border-collapse h-full table-fixed", isPrint ? "border border-emerald-950" : "")}>
            ...
            <tbody>
              {days.map(day => {
                ...
                return (
                  <tr key={day.id} className={cn(isPrint ? "h-8" : "h-10", !isPrint && isRowHovered && "bg-emerald-50/20")}>
        ...
        <table className={cn("w-full border-collapse h-full table-fixed", isPrint ? "border border-emerald-950" : "")}>
          ...
          <tbody>
            {timeSlots.map(slot => {
              ...
              return (
                <React.Fragment key={slot.id}>
                  <tr className={cn(isPrint ? "h-8" : "h-10", !isPrint && isRowHovered && "bg-emerald-50/20")}>
